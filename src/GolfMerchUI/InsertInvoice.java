...
public class InsertInvoice extends javax.swing.JFrame {
    ...
    /**
     * Creates new form InsertInvoice
     */
    ...
    public InsertInvoice() {
        try {
            ...
            db = new DBManager();
            db.connect();
            orderIDComboBox.setModel(new DefaultComboBoxModel(db.getAllOrders()));
    ...
    private void initComponents() {
        ...
        amountPaidTextFld.setText("0.00");

        insertBtn.setText("Insert Invoice");
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(amountPaidLbl, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                            .addComponent(orderIDLbl, javax.swing.GroupLayout.PREFERRED_SIZE, 80, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addGap(18, 18, 18)
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
    ...
    private void insertBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_insertBtnActionPerformed
        if(Double.parseDouble(amountPaidTextFld.getText()) == 0)
        {
            JOptionPane.showMessageDialog(this,"Amount Paid must be greater than 0");
        }
        else try {
            if(Double.parseDouble(amountPaidTextFld.getText()) > db.getTotalAmountForOrder((String)orderIDComboBox.getSelectedItem()))
            {
                JOptionPane.showMessageDialog(this,"Error amount paid must be less than or equal to total order price");
            }
            else
            {
                if(db.insertNewInvoice((String)orderIDComboBox.getSelectedItem(),Double.parseDouble(amountPaidTextFld.getText())))
                {   // Successful insert
                    setVisible(false);
                    dispose();
                }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new InsertInvoice().setVisible(true);
            }
        });
    }
